...
class WorkspacesOperations:
    ...
    def list(
        ...
        if raw:
            header_dict = {}
        deserialized = models.WorkspacePaged(
    ...
    async def create_or_update(
        ...
        :return: An instance of Workspace or ClientRawResponse<Workspace> if
         raw==True
        :rtype: ~~azure.mgmt.loganalytics.models.Workspace or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.loganalytics.models.Workspace]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
