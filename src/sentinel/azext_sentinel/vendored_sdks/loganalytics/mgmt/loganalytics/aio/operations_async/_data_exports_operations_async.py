...
class DataExportsOperations:
    ...
    def list_by_workspace(
        ...
        if raw:
            header_dict = {}
        deserialized = models.DataExportPaged(
    ...
    async def create_or_update(
        ...
        :return: An instance of DataExport or ClientRawResponse<DataExport> if
         raw==True
        :rtype: ~~azure.mgmt.loganalytics.models.DataExport or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.loganalytics.models.DataExport]
        :raises:
         :class:`DataExportErrorResponseException<azure.mgmt.loganalytics.models.DataExportErrorResponseException>`
        """
