...
class Case(ResourceWithEtag):
    ...
    :type close_reason: str or ~securityinsights.models.CloseReason
    ...
    :type owner: ~securityinsights.models.UserInfo
    ...
    :type severity: str or ~securityinsights.models.CaseSeverity
    ...
    :type status: str or ~securityinsights.models.CaseStatus
