...
class BookmarkOperations(object):
    ...
    def expand(
            self, resource_group_name, operational_insights_resource_provider, workspace_name, bookmark_id, parameters, custom_headers=None, raw=False, **operation_config):
        """Expand an bookmark.
        ...
        :param parameters: The parameters required to execute an expand
         operation on the given bookmark.
        :type parameters: ~securityinsights.models.BookmarkExpandParameters
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: BookmarkExpandResponse or ClientRawResponse if raw=true
        :rtype: ~securityinsights.models.BookmarkExpandResponse or
        ...
        # Construct body
        body_content = self._serialize.body(parameters, 'BookmarkExpandParameters')
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('BookmarkExpandResponse', response)
        ...
        return deserialized
    expand.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{operationalInsightsResourceProvider}/workspaces/{workspaceName}/providers/Microsoft.SecurityInsights/bookmarks/{bookmarkId}/expand'}
