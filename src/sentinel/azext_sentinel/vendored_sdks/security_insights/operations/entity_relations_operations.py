...
class EntityRelationsOperations(object):
    ...
    def get_relation(
            self, resource_group_name, operational_insights_resource_provider, workspace_name, entity_id, relation_name, custom_headers=None, raw=False, **operation_config):
        ...
        return deserialized
    get_relation.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{operationalInsightsResourceProvider}/workspaces/{workspaceName}/providers/Microsoft.SecurityInsights/entities/{entityId}/relations/{relationName}'}
