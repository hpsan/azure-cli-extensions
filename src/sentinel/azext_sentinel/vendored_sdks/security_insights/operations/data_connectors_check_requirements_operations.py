...
class DataConnectorsCheckRequirementsOperations(object):
    ...
    def post(
            self, resource_group_name, workspace_name, operational_insights_resource_provider, data_connectors_check_requirements, custom_headers=None, raw=False, **operation_config):
        ...
        :param data_connectors_check_requirements: The parameters for
         requirements check message
        :type data_connectors_check_requirements:
         ~securityinsights.models.DataConnectorsCheckRequirements
        ...
        :return: DataConnectorRequirementsState or ClientRawResponse if
         raw=true
        :rtype: ~securityinsights.models.DataConnectorRequirementsState or
        ...
        return deserialized
    post.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{operationalInsightsResourceProvider}/workspaces/{workspaceName}/providers/Microsoft.SecurityInsights/dataConnectorsCheckRequirements'}
