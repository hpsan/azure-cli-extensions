...
class EntitiesOperations(object):
    ...
    def list(
        ...
        :return: EntityList or ClientRawResponse if raw=true
        :rtype: ~securityinsights.models.EntityList or
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('EntityList', response)
    ...
    def get(
        ...
        :rtype: ~securityinsights.models.Entity or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`CloudErrorException<securityinsights.models.CloudErrorException>`
        """
    ...
    def expand(
        ...
        :type parameters: ~securityinsights.models.EntityExpandParameters
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
        ...
        :rtype: ~securityinsights.models.EntityExpandResponse or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`CloudErrorException<securityinsights.models.CloudErrorException>`
        """
