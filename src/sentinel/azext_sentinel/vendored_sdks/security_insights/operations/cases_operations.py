...
class CasesOperations(object):
    ...
    def list(
        ...
        :return: CaseList or ClientRawResponse if raw=true
        :rtype: ~securityinsights.models.CaseList or
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('CaseList', response)
    ...
    def get(
        ...
        :rtype: ~securityinsights.models.Case or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`CloudErrorException<securityinsights.models.CloudErrorException>`
        """
    ...
    def create_or_update(
        ...
        :type case_id: str
        :param case: The case
        :type case: ~securityinsights.models.Case
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
