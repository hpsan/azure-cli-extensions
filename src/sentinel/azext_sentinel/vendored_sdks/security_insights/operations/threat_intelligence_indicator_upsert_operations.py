...
class ThreatIntelligenceIndicatorUpsertOperations(object):
    """ThreatIntelligenceIndicatorUpsertOperations operations.
    ...
    def create(
            self, resource_group_name, operational_insights_resource_provider, workspace_name, name, threat_intelligence_indicator_object_to_upsert, custom_headers=None, raw=False, **operation_config):
        ...
        :type name: str
        :param threat_intelligence_indicator_object_to_upsert: The threat
         intelligence entity properties for upsert
        :type threat_intelligence_indicator_object_to_upsert:
        ...
        # Construct body
        body_content = self._serialize.body(threat_intelligence_indicator_object_to_upsert, 'ThreatIntelligenceIndicatorWithoutReadOnlyFields')
