...
class ThreatIntelligenceIndicatorsOperations(object):
    ...
    def list(
            self, resource_group_name, operational_insights_resource_provider, workspace_name, filter=None, top=None, skip_token=None, orderby=None, custom_headers=None, raw=False, **operation_config):
        ...
        return deserialized
    list.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{operationalInsightsResourceProvider}/workspaces/{workspaceName}/providers/Microsoft.SecurityInsights/threatIntelligence/main/indicators'}
