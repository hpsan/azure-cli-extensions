...
class CaseCommentsOperations(object):
    ...
    def create_comment(
            self, resource_group_name, operational_insights_resource_provider, workspace_name, case_id, case_comment_id, case_comment, custom_headers=None, raw=False, **operation_config):
        ...
        :param case_comment: The case comment
        :type case_comment: ~securityinsights.models.CaseComment
        ...
        :rtype: ~securityinsights.models.CaseComment or
