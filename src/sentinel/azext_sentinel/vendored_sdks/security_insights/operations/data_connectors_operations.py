...
class DataConnectorsOperations(object):
    ...
    def list(
        ...
        :return: DataConnectorList or ClientRawResponse if raw=true
        :rtype: ~securityinsights.models.DataConnectorList or
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('DataConnectorList', response)
    ...
    def get(
        ...
        :rtype: ~securityinsights.models.DataConnector or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`CloudErrorException<securityinsights.models.CloudErrorException>`
        """
    ...
    def create_or_update(
        ...
        :type data_connector: ~securityinsights.models.DataConnector
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
